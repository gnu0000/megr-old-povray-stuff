...
light_source { <-5, 5, -50.0> colour White * 0.8 }
...
text 
   { 
   ttf "c:\winnt\fonts\arial.ttf" "C" .3, 0 
   texture 
      {
	   pigment {color red 0.13 green 0.52 blue 0.28}
	   finish 
	      {
	      specular 0.5 roughness 0.15 // Dull
	      ambient .4
...
#while (CountO < 360)
   ...
   #while (Count < 3.14159)
      object
         ...
         rotate <0, 12 + CountO + Count * 90/3.14159 * 2, 0>
         }
